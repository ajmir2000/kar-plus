...
export default function TalentBox() {
  return (
    <div className=" custom-talent-box-container  d-flex m-2 ">
      <div className="custom-talent-box-skill-pic m-4">
        <img src="./asset-folder/talent-pics/download.jpeg" alt="talent pic" />
      </div>
      ...
      <div className="d-flex justify-content-center mt-3 flex-column">
        ...
        <div className="m-4 custom-talent-box-text-body  ">
          <p>
            ...
            dolores est autem nobis earum saepe architecto optio enim assumenda
            nulla perferendis ad, beatae animi repellat dicta sed ipsam
            aspernatur hic! Lorem ipsum dolor sit
          </p>
